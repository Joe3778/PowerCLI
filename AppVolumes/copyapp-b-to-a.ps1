...
copy ds:\cloudvolumesPodB\apps\$appname* ds:\cloudvolumes\apps\ -Confirm

#Tell the user they are not done
Write-Host -ForegroundColor Green "**********************************"
Write-Host -ForegroundColor Green "You must now go to the Pod A manager and import the AppStack."
Write-Host -ForegroundColor Green "**********************************"
